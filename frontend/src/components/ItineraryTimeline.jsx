...
function SlotRow({ slot, linkage, business, onClick, translationTarget }) {
  ...
  return (
    ...
    >
      ...
      <div className="card" style={{ padding: 14, cursor: linkage ? "pointer" : "default" }} onClick={() => linkage && onClick?.(linkage)}>
        <div className="row" style={{ justifyContent: "space-between" }}>
          <strong style={{ fontFamily: "var(--font-display)" }}>{slot.time}</strong>
          <div className="row">
        ...
        <div className="mt-3">
          {business ? (
            ...
            <div className="text-muted">No business assigned</div>
          )}
        </div>
        {linkage && (
          <div className="mt-3" style={{ borderTop: "1px solid var(--border-glass)", paddingTop: 10 }}>
